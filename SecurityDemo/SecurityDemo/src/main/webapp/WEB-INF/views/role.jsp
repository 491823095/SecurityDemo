...
<script type="text/javascript">
    $(function () {
        ...
        $(".saveRoleAcl").click(function (e) {
            e.preventDefault();
            //-1是初始值，证明用户没有选择任何角色 $(".saveRoleAcl")
            if (lastRoleId==-1){
        ...
        $("#roleTab a[data-toggle='tab']").on("show.bs.tab",function (e) {
            if (lastRoleId==-1){
                showMessage("加载角色关系","请先选择操作的角色",false);
                return;
            }
            //判断是第一个标签还是第二个标签
